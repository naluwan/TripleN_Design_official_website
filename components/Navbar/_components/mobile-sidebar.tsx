...
import sheetLogo from '@/public/TripleNDesign-nav-logo.png';
    ...
    <Sheet>
      ...
      <SheetContent side='right' className='bg-white p-0'>
        <div className='flex h-full flex-col overflow-y-auto border-r bg-white shadow-sm'>
          ...
          <div className='flex flex-col items-center justify-center py-2 text-xs max-md:text-[10px]'>
            <p className='m-0'>仨恩網頁設計工作室 版權所有</p>
            <p className='m-0'>
              Copyright 2024 &copy; TripleN Design Co. Ltd. All rights reserved.
            </p>
